...
Below are the details and installation instructions for the Linux setup I'm running. This configuration is quite specific for me and my personal needs, so it might require some adaptation if you are installing your own version. Furthermore the instructions are quite minimal and without much explaination. For more detailed explaination and troubleshooting if you encounter issues please see [wiki.archlinux.org/title/Installation_guide](https://wiki.archlinux.org/title/Installation_guide){:target="_blank"}
