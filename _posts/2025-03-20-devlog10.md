...
A more or less essential component needed for procedural generation is a good noise algorithm. In order to start working on terrain generation I'll first this to the project. I've opted for the Improved Perlin Noise algorithm. But another good alternative that is ready and available for C# is [OpenSimplex2](https://github.com/KdotJPG/OpenSimplex2.git){:target="_blank"}
